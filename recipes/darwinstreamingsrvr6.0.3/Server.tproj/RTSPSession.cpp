    ...
    while (this->IsLiveSession())
    {
        ...
        switch (fState)
        {
            ...
            case kFilteringRequest:
            {
                ...
                // Invoke filter modules，用于二次开发，对客户的请求做出特殊处理
            ...
            // 调用二次开发加入的路由模块，缺省情况下，系统本身对此状态不做处理
            ...
            case kSendingResponse:
            {
                ...
                // 将在fOutputStream中尚未发出的请求响应通过Socket端口完全发送出去
                err = fOutputStream.Flush();
            ...
            case kCleaningUp:
            {
                ...
                // 清除所有上次处理的数据，并将状态设置为kReadingRequest等待下次请求到达
                this->CleanupRequest();
